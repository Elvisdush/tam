...
export default function ChatScreen() {
  ...
  const { messages, sendMessage, deleteMessage } = useChatStore();
  ...
  const renderMessage = ({ item }: { item: any }) => {
    ...
    return (
      ...
      >
        {!isMyMessage && (
          <Image 
            source={{ uri: chatPartner?.profileImage || 'https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=1480&auto=format&fit=crop' }} 
      ...
      <View style={styles.header}>
        ...
        >
          <Svg width="24" height="24" viewBox="0 0 24 24">
            {/* Share Location Icon Drawing */}
            <Circle cx="12" cy="12" r="10" stroke="#007AFF" strokeWidth="2" fill="none" />
            <Circle cx="12" cy="12" r="3" fill="#007AFF" />
            <Path d="M12 2 L12 6" stroke="#007AFF" strokeWidth="2" strokeLinecap="round" />
            <Path d="M12 18 L12 22" stroke="#007AFF" strokeWidth="2" strokeLinecap="round" />
            <Path d="M22 12 L18 12" stroke="#007AFF" strokeWidth="2" strokeLinecap="round" />
            <Path d="M6 12 L2 12" stroke="#007AFF" strokeWidth="2" strokeLinecap="round" />
            <Path d="M19.07 4.93 L16.24 7.76" stroke="#007AFF" strokeWidth="2" strokeLinecap="round" />
            <Path d="M7.76 16.24 L4.93 19.07" stroke="#007AFF" strokeWidth="2" strokeLinecap="round" />
            <Path d="M19.07 19.07 L16.24 16.24" stroke="#007AFF" strokeWidth="2" strokeLinecap="round" />
            <Path d="M7.76 7.76 L4.93 4.93" stroke="#007AFF" strokeWidth="2" strokeLinecap="round" />
          </Svg>
        </TouchableOpacity>
      </View>
