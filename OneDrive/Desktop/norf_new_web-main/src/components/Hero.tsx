      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="#work"
              className="px-8 py-4 bg-gradient-to-r from-amber-400 to-rose-500 text-white font-medium rounded-full hover:opacity-90 transition-opacity"
            >
              View Our Work
            </a>
            <a
              href="#contact"
              className="px-8 py-4 bg-transparent border-2 border-white/20 text-white font-medium rounded-full hover:bg-white/10 transition-colors"
            >
              Get in Touch
            </a>
          </motion.div>
