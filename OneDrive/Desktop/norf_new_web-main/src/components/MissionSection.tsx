...
export const MissionSection = () => {
  return <section className="w-full bg-[#B8ADA0]">
      ...
      <div className="w-full bg-background py-16 px-12 md:px-16 lg:px-20">
        <p className="text-[54px] font-playfair text-foreground max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 min-h-screen">
        ...
        borderColor: '#eee9e6'
          ...
          <h2 className="text-[20px] font-montserrat font-light leading-tight" style={{ color: '#eee9e6' }}>
          ...
          <a 
            href="https://instagram.com/nor4artists" 
            target="_blank" 
        ...
        borderColor: '#eee9e6'
          ...
          <p className="text-base md:text-lg lg:text-xl font-montserrat leading-relaxed max-w-lg" style={{ color: '#eee9e6' }}>
            Nor4Artists is a dedicated music marketing division of Norf Cre8ions, focused on helping aspiring musicians grow and establish their brands. We understand the challenges of breaking into the industry, which is why we provide tailored marketing strategies designed to amplify an artist's reach and impact.
          </p>
          <a 
            href="https://instagram.com/nor4artists" 
        ...
        borderColor: '#eee9e6'
          ...
          <p className="text-base md:text-lg lg:text-xl font-montserrat leading-relaxed max-w-lg" style={{ color: '#eee9e6' }}>Sports Palettes is a creative division of Norf Cre8ions, dedicated to elevating the digital presence of sports teams in Rwanda. Specializing in dynamic branding, innovative content creation, and eye-catching graphics, we collaborate with teams to craft vibrant and engaging visuals.</p>
          <a 
            href="https://instagram.com/sportspalettes" 
            target="_blank" 
            rel="noopener noreferrer"
            className="absolute inset-0 flex items-center justify-center bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          >
